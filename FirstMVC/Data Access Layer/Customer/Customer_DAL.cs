    ...
    public class Customer_DAL : ICustomer_DAL
    {
        ...
        public List<Customer> GetAll(string cuid)
        {
            ...
            strQ ="SELECT Customer.id, Customer.CUId, CreditUnion.CUName, Customer.CustomerName, Customer.CoBorrowerName, Customer.FirstName, Customer.LastName, Customer.CCSocialNum, Customer.DrivingLic, Customer.DOB, Customer.Address, Customer.Phone, Customer.Email, Customer.Active " +
                            ",LoanInfo.LTV, LoanInfo.Rate, LoanInfo.Term, LoanInfo.ApprovalAmt, LoanInfo.PreApprovExpirationDate, LoanInfo.LoanDoc" +
        ...
        public Customer Add(Customer customer)
        {
            ...
            sqlQuery = "INSERT INTO LoanInfo (CUId, CustomerId, LTV, Rate, Term, ApprovalAmt, PreApprovExpirationDate, LoanDoc, Active) VALUES(@CUId, " + CustomerId + ", @LTV, @Rate, @Term, @ApprovalAmt, @PreApprovExpirationDate, @LoanDoc, 1); " + "SELECT CAST(SCOPE_IDENTITY() as int)";
